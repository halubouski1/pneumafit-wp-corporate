<?php
/**
 * Template for the Physiotherapie page (slug: physiotherapie).
 */
get_header();
?>
    ...
    <div class="container osteopathy-hero__container">
      ...
      <div class="osteopathy-hero__content">
        <div class="osteopathy-hero__main">
          ...
          <h1 class="osteopathy-hero__title">Physiotherapie</h1>
  ...
  <section class="section-philosophy" data-aos="fade-up" data-aos-duration="900">
    ...
    <div class="philosophy-top">
      <span class="philosophy-label">Der erste Schritt:</span>
      <div class="philosophy-main">
        <h2 class="philosophy-title">Wiederherstellung, Rehabilitation & Prävention</h2>
        <p class="philosophy-text">Die moderne Physiotherapie hat das Ziel Mobilität zurückzugewinnen und Beschwerden zu reduzieren, vor allem im Anschluss an Unfälle oder chirurgische Eingriffe. <br>
          Darüber hinaus unterstützen wir Menschen mit chronischen Krankheiten dabei, ihre körperliche Leistungsfähigkeit zu optimieren und so ein unabhängigeres Leben zu gestalten.</p>
    ...
    <div class="philosophy-words" aria-hidden="true">
      ...
      <div class="pw-group">
        <span class="p-word p-word--1">Mobilität</span>
        <span class="p-word p-word--2">Rehabilitation</span>
      </div>
      <div></div><!-- col 2: 178px spacer -->
      <!-- col 3: 296px — 1 word centered -->
      <span class="p-word p-word--3">Prävention</span>
      <div></div><!-- col 4: 178px spacer -->
      <!-- col 5: 296px — 2 words centered as group -->
      <div class="pw-group">
        <span class="p-word p-word--4">Gesundheit</span>
        <span class="p-word p-word--5">Kraft</span>
      </div>
      <div></div><!-- col 6: 178px spacer -->
      <div></div><!-- col 7: 296px empty (lines 7→8) -->
      <!-- col 8: remaining — 1 word centered -->
      <span class="p-word p-word--6">Stabilität</span>
    </div>
  ...
  <section class="section-for-back" data-aos="fade-up" data-aos-duration="900">
    <div class="for-back__inner">
      ...
      <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/physiotherapie-cards-bg.jpg" class="for-back__mobile-img" alt="" aria-hidden="true">
    ...
    <div class="mission__inner">
      ...
      <div class="mission__left">
        <h2 class="mission__left-title">Ganzheitliche Physiotherapie</h2>
        <p class="mission__left-text">Das Hauptziel unserer physiotherapeutischer Maßnahmen ist es, Ihre Beschwerden in betroffenen Extremitäten oder Gelenken zu mindern. Ein weiterer Vorteil unserer Behandlungen ist die potenzielle Steigerung von Bewegungsfreiheit, Koordination, Stärke und Ausdauer.</p>
      </div>

      <div class="mission__right">

        <div class="mission__right-top">
          <p class="mission__right-text">Mit der Anwendung vieler verschiedener Techniken, wie spezielle Übungen, Massagen und Lymphdrainagen, behandeln wir Ihre Beschwerden mit dem Bewegungsapparat und den Körperfunktionen.</p>
        ...
        <div class="mission__right-bottom">
          <h2 class="mission__bottom-title">Durch dein Einsatz unserer Therapien können oft sogar Operationen und Medikamente vermieden oder zumindest reduziert werden.</h2>
          <span class="mission__bottom-sub">Die Physiopraxis PneumaFit in Leinfelden-Echterdingen ist immer für Sie da und freut sich auf Ihren Besuch.</span>
        </div>
    ...
    <div class="section-mission__mobile">
      ...
      <h2 class="mission-mob__title">Ganzheitliche Physiotherapie</h2>

      <div class="mission-mob__texts">
        <p class="mission-mob__text">Das Hauptziel unserer physiotherapeutischer Maßnahmen ist es, Ihre Beschwerden in betroffenen Extremitäten oder Gelenken zu mindern. Ein weiterer Vorteil unserer Behandlungen ist die potenzielle Steigerung von Bewegungsfreiheit, Koordination, Stärke und Ausdauer.</p>
      </div>

      <img class="mission-mob__img" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/holistic-physiotherapy.jpg" alt="" aria-hidden="true">

      <h2 class="mission-mob__bottom-title">Durch dein Einsatz unserer Therapien können oft sogar Operationen und Medikamente vermieden oder zumindest reduziert werden.</h2>
      <span class="mission-mob__sub">Die Physiopraxis PneumaFit in Leinfelden-Echterdingen ist immer für Sie da und freut sich auf Ihren Besuch.</span>
      
      <div class="mission-mob__bottom">
        <div class="mission-mob__divider">
        </div>
        <p class="mission-mob__text">Mit der Anwendung vieler verschiedener Techniken, wie spezielle Übungen, Massagen und Lymphdrainagen, behandeln wir Ihre Beschwerden mit dem Bewegungsapparat und den Körperfunktionen.</p>
      ...
      <div class="section-reviews__inner">
        ...
        <div class="section-process__top">
          <div class="section-process__left">
            <h2 class="section-title section-reviews__title section-process__title">Unsere Anwendungen für Sie</h2>
            <p class="section-process__text">In unseren Einrichtungen in angenehmster Atmosphäre in Leinfelden-Echterdingen bieten wir Ihnen ein umfassendes Angebot an physiotherapeutischen Behandlungen für mehr Gesundheit und Wohlbefinden.</p>
          </div>
        </div>
              ...
              <div class="swiper-wrapper">
                  ...
                  <div class="review-card">
                    <div class="review-card__inner">
                      <div class="review-card__bottom">
                        <h3 class="review-card__service">Allgemeine Physiotherapie</h3>
                        <ul class="review-card__list">
                          <li class="review-card__item">Allgemeine Physiotherapie</li>
                          <li class="review-card__item">Manuelle Behandlung</li>
                          <li class="review-card__item">Lymphatische Drainage</li>
                          <li class="review-card__item">Gerätegestütze Physiotherapie (GPP)</li>
                          <li class="review-card__item">Medizinische und traditionelle Massage</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="review-card">
                    <div class="review-card__inner">
                      <div class="review-card__bottom">
                        <h3 class="review-card__service">Zusätzliche Anwendungen</h3>
                        <ul class="review-card__list">
                          <li class="review-card__item">Wärmebehandlungen (z.B. Heißluft, Naturmoorpackungen, heiße Wickel)</li>
                          <li class="review-card__item">Kältetherapie (wie Eispackungen)</li>
                          <li class="review-card__item">Elektrotherapeutische Anwendungen</li>
                          <li class="review-card__item">Ultraschalltherapie</li>
                          <li class="review-card__item">Dehnungstherapie (z.B. am Schlingentisch, Gymwood-Geräte)</li>
                        </ul>
                      </div>
                    </div>
                  </div>
                ...
                <div class="swiper-slide">
                  <div class="review-card">
                    <div class="review-card__inner">
                      <div class="review-card__bottom">
                        <h3 class="review-card__service">PneumaFit Spezialgebiete</h3>
                        <ul class="review-card__list">
                          <li class="review-card__item">Skoliose-Behandlung (nach modernen Methoden)</li>
                          <li class="review-card__item">Nachsorge nach Operationen, z.B. nach Gelenkersatz oder Kreuzbandoperationen</li>
                          <li class="review-card__item">Sportbezogene Physiotherapie und Behandlung von Sportverletzungen</li>
                          <li class="review-card__item">Rücken fokussierte Physiotherapie</li>
                          <li class="review-card__item">Spezialbehandlungen in der Neurophysiotherapie, z.B. nach einem</li>
                          <li class="review-card__item">Schlaganfall, bei Parkinson oder anderen neurologischen Erkankungen</li>
                          <li class="review-card__item">Kinesiologisches Taping</li>
                        </ul>
                      </div>
                    </div>
                  </div>
    ...
    <div class="section-contact__wrap">
      <img class="section-contact__video" src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/physiotherapie-footer.png" alt="" aria-hidden="true">

      <div class="section-contact__inner">
        <span class="section-contact-mobile-text">
          Heilpraktische Verfahren und T Shape 2 gehören zur Komplementärmedizin/Ästhetik. 
        </span>
        <div class="section-contact__left">
          ...
          <div class="section-contact__bottom">
            ...
            <div class="section-contact__form-holder" id="physioFormHolder">
            <?php
      ...
      <?php // #physioFormHolder (single GF instance) is moved here from the desktop block by JS at <=940px. ?>
